#' @title PhenAnoma
#' @description Calculates anomalies with respect to the regular phenological cycle using time series (numeric vector) of vegetation greenness.
...
PhenAnoma <-
  function(x,dates,h,refp,anop,rge) {
